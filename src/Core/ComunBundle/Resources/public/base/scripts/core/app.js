    ...
    return {
        ...
        loadAjax: function(url,target,params){
            ...
            $.ajax({
                ...
                error: function (xhr, ajaxOptions, thrownError) {
                    pageContentBody.html('<h4>The content cannot be loaded.</h4>');
                        App.toast("A error with permissions occurs, you will be redirected to login page",Mensajes.OpError,TOAST.ERROR);
                           window.location.href = "http://localhost/app.php/";
