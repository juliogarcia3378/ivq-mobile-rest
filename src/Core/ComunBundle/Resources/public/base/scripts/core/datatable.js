...
var Datatable = function () {
    ...
    var countSelectedRecords = function() {
        ...
        if (selected > 0) {
            $('.table-group-actions > span', tableWrapper).text(text.replace("_TOTAL_", selected+(selected > 1 ? " selected": " selected")));
        } else {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "oLanguage": {  // language settings
                        "sProcessing": '<img src="'+GLOBAL.loadingSpinner+'"/><span>&nbsp;&nbsp;Loading Information...</span>',
                        "sLengthMenu": "<span class='seperator'>|</span>Show _MENU_ Items",
                        "sInfo": "<span class='seperator'>|</span>Items _TOTAL_ found",
                        "sInfoEmpty": "No items found",
                        "sGroupActions": "_TOTAL_",
                        "sAjaxRequestGeneralError": "The operation cannot be completed.",
                        ...
                        oSettings.jqXHR = $.ajax( {
                          ...
                          //      alert(1);
                                if (jqXHR==="Unauthorized" || jqXHR==="Not Found"){
                                    App.toast("A security exception found, you will be redirected to login",Mensajes.OpError,TOAST.ERROR);
