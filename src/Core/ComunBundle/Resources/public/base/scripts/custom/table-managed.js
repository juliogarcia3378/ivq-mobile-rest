    ...
    var handleRecords = function(tableId,extraActions) {
            ...
            dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                fnInitComplete: function(oSettings,json){
                    ...
                    $("#"+oSettings.sTableId+" .eliminar_elemento").on('click',function(e){
                        ...
                        if (confirm("¿Are you sure about deleting this item?") == false) {
                            return;
                        }
        ...
        grid.getTableWrapper().on('click', '.table-group-action-submit', function(e){
            ...
            if (action.val() != "" && grid.getSelectedRowsCount() > 0) {
                ...
                App.alert({type: 'danger', icon: 'warning', message: 'Select an action.', container: grid.getTableWrapper(), place: 'prepend'});
            } else if (grid.getSelectedRowsCount() === 0) {
                App.alert({type: 'danger', icon: 'warning', message: 'No items selected.', container: grid.getTableWrapper(), place: 'prepend'});
            }
        });
