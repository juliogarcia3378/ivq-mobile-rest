...
abstract class TableModel  extends ContainerAware{
    ...
    public function getBotonEditar($text = "Modify")
    {
        return '<a class="btn btn-large editar_elemento tooltips" style="padding-bottom: 0px; padding-top: 0px"  data-original-title="Update" data-placement="top"><i class="fa fa-edit " style="text-decoration: underline"></i> </a>';
//        return '<a class="btn btn-xs default editar_elemento" data-target="#ajax" data-toggle="modal"><i class="fa fa-edit"></i> '.$text.'</a>';
    }
    public function getBotonEliminar($text = "Delete")
    {
        return '<a class="btn btn-large  eliminar_elemento tooltips" style="padding-bottom: 0px; padding-top: 0px"  data-original-title="Delete" data-placement="top"><i class="fa fa-trash-o " style="text-decoration: underline"></i> </a>';
    }
    public function getBotonDetalles($text = "Details")
    {
        return '<a class="btn btn-large detalles_elemento tooltips"  style="padding-bottom: 0px; padding-top: 0px" data-original-title="Details" data-placement="top"> <i class="fa fa-eye" style="text-decoration: underline"></i> </a>';
    }
