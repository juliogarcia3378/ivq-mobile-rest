 ...
 */
class Advertiser extends \AppBundle\Entity\Advertiser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Advertiser' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Advertiser' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Advertiser' . "\0" . 'category', '' . "\0" . 'AppBundle\\Entity\\Advertiser' . "\0" . 'groups'];
        }
