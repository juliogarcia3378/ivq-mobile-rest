...
class Event extends \AppBundle\Entity\Event implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'paid_event', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'finish_date', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'address', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'ticket_url', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'information', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'updated_at', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'website', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'logo', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'price', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'groups', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'mediaEvent'];
        }
