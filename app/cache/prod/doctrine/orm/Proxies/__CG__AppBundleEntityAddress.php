...
class Address extends \AppBundle\Entity\Address implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Address' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Address' . "\0" . 'address', '' . "\0" . 'AppBundle\\Entity\\Address' . "\0" . 'city', '' . "\0" . 'AppBundle\\Entity\\Address' . "\0" . 'state', '' . "\0" . 'AppBundle\\Entity\\Address' . "\0" . 'zip', '' . "\0" . 'AppBundle\\Entity\\Address' . "\0" . 'groups'];
        }
