...
class Groups extends \AppBundle\Entity\Groups implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'active', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'address', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'phone', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'website', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'logo', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'category', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'event', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'broadcast', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'member', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'coupon', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'file', '' . "\0" . 'AppBundle\\Entity\\Groups' . "\0" . 'advertiser'];
        }
    ...
    public function addBroadcast(\AppBundle\Entity\Broadcast $broadcast)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addBroadcast', [$broadcast]);

        return parent::addBroadcast($broadcast);
    }
    ...
    public function removeBroadcast(\AppBundle\Entity\Broadcast $broadcast)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeBroadcast', [$broadcast]);

        return parent::removeBroadcast($broadcast);
    }
    ...
    public function getBroadcast()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBroadcast', []);
