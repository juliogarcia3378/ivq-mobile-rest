...
class Coupon extends \AppBundle\Entity\Coupon implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Coupon' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Coupon' . "\0" . 'code', '' . "\0" . 'AppBundle\\Entity\\Coupon' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Coupon' . "\0" . 'information', '' . "\0" . 'AppBundle\\Entity\\Coupon' . "\0" . 'expires_at', '' . "\0" . 'AppBundle\\Entity\\Coupon' . "\0" . 'barcode', '' . "\0" . 'AppBundle\\Entity\\Coupon' . "\0" . 'logo', '' . "\0" . 'AppBundle\\Entity\\Coupon' . "\0" . 'groups'];
        }
