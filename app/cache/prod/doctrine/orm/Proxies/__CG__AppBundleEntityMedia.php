...
class Media extends \AppBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Media' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Media' . "\0" . 'format', '' . "\0" . 'AppBundle\\Entity\\Media' . "\0" . 'url', '' . "\0" . 'AppBundle\\Entity\\Media' . "\0" . 'mediaEvent'];
        }
