...
class Broadcast extends \AppBundle\Entity\Broadcast implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'groups', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'format', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'status', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'advertiser', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'broadcastType', 'path'];
        }

        return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'groups', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'format', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'status', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'advertiser', '' . "\0" . 'AppBundle\\Entity\\Broadcast' . "\0" . 'broadcastType'];
    }
