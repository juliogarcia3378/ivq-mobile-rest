...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'profile', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'advertiser', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'invalidAttempts', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'member', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'following', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'follower', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'favourite_group', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'favourite_member', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'businesscard', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'media', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'comment', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'likeMedia', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'attendee', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'accessToken', 'token', 'linkedinID', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
